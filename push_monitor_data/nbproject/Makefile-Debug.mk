...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/push_monitor_data: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/push_monitor_data ${OBJECTFILES} ${LDLIBSOPTIONS} -lthrift -lboost_system

${OBJECTDIR}/get_computer_info.o: get_computer_info.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/get_computer_info.o get_computer_info.cpp

${OBJECTDIR}/main_push_monitor_data_client.o: main_push_monitor_data_client.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_push_monitor_data_client.o main_push_monitor_data_client.cpp

${OBJECTDIR}/sigar/linux_sigar.o: sigar/linux_sigar.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/linux_sigar.o sigar/linux_sigar.c

${OBJECTDIR}/sigar/sigar.o: sigar/sigar.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar.o sigar/sigar.c

${OBJECTDIR}/sigar/sigar_cache.o: sigar/sigar_cache.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_cache.o sigar/sigar_cache.c

${OBJECTDIR}/sigar/sigar_fileinfo.o: sigar/sigar_fileinfo.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_fileinfo.o sigar/sigar_fileinfo.c

${OBJECTDIR}/sigar/sigar_format.o: sigar/sigar_format.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_format.o sigar/sigar_format.c

${OBJECTDIR}/sigar/sigar_getline.o: sigar/sigar_getline.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_getline.o sigar/sigar_getline.c

${OBJECTDIR}/sigar/sigar_ptql.o: sigar/sigar_ptql.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_ptql.o sigar/sigar_ptql.c

${OBJECTDIR}/sigar/sigar_signal.o: sigar/sigar_signal.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_signal.o sigar/sigar_signal.c

${OBJECTDIR}/sigar/sigar_util.o: sigar/sigar_util.c 
	${MKDIR} -p ${OBJECTDIR}/sigar
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sigar/sigar_util.o sigar/sigar_util.c

${OBJECTDIR}/thrift_gen_code/databaseCenter.o: thrift_gen_code/databaseCenter.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift_gen_code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift_gen_code/databaseCenter.o thrift_gen_code/databaseCenter.cpp

${OBJECTDIR}/thrift_gen_code/demo_monitor_constants.o: thrift_gen_code/demo_monitor_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift_gen_code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift_gen_code/demo_monitor_constants.o thrift_gen_code/demo_monitor_constants.cpp

${OBJECTDIR}/thrift_gen_code/demo_monitor_types.o: thrift_gen_code/demo_monitor_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/thrift_gen_code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thrift_gen_code/demo_monitor_types.o thrift_gen_code/demo_monitor_types.cpp
